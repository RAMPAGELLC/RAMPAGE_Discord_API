Config = {
    ...
    UpdateRate = 30, -- Rate of re-fetching roles after cache. (in seconds)
    GuildId = 123, -- Primary Guild Id (Defaults to this if no guild is specified for some exports)
    Guilds = { -- Guilds bot is in & allowed to interact with.
    123, 124, 125},
    Notifications = {
        NotificationRate = 15, -- Rate of comparing cache & current roles for notification events.
